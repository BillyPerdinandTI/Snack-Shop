...
$link=JROUTE::_('index.php?option=com_virtuemart&view=updatesmigration&task=installComplete&'.vRequest::getFormToken().'=1&token='.vRequest::getFormToken().'&installVM=1' ); ?>
...
<?php	$link=JROUTE::_('index.php?option=com_virtuemart&view=updatesmigration&task=installCompleteSamples&'.vRequest::getFormToken().'=1&token='.vRequest::getFormToken().'&installVM=1'); ?>
	<div class="icon"><a onclick="javascript:confirmation('<?php echo $link; ?>');">
			<span class="vmicon48"></span>
