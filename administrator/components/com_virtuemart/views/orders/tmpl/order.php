 ...
 * @version $Id: order.php 11124 2025-05-23 16:11:04Z Milbo $
 */
	...
	<tr>
		...
		<table class="adminlist" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				$link = 'index.php?option=com_virtuemart&view=orders&task=toggle.paid.'.$val.'&cidName=virtuemart_order_id&virtuemart_order_id[]='.$this->orderID.'&rtask=edit&'.vRequest::getFormToken().'=1';
				...
				<?php
					...
					$link = 'index.php?option=com_virtuemart&view=orders&task=toggle.invoice_locked.'.$val.'&cidName=virtuemart_order_id&virtuemart_order_id[]='.$this->orderID.'&rtask=edit&'.vRequest::getFormToken().'=1';
