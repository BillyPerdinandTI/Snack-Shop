...
/**
 * Derived from File.php of the Joomla Framework Filesystem Package and vFile
 *
...
class vFile
{
	...
	public static function makeSafe($file, array $stripChars = ['#^\.#']) {
		...
		return vRequest::filterPath($file);
	}
