 ...
 * @version $Id: userfields.php 11187 2025-09-10 19:33:56Z Milbo $
 */
	...
	public function getUserFieldsFilled($_selection, &$_userDataIn = null, $_prefix = '', $defaults = false){
		...
		if (is_array($_selection)) {
			...
			foreach ($_selection as $_fld) {
				...
				//We have our default value, so we skip the rest if we are in default mode, except for country and state
