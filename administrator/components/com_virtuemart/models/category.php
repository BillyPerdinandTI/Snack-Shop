...
* @version $Id: category.php 11110 2025-04-07 08:42:06Z Milbo $
*/
...
//for( $i=0; $i<count($allCats); $i++ ){
	...
	WHERE  `virtuemart_category_id`='.(int)$data['virtuemart_category_id'].';';
			$db = JFactory::getDbo();
			$db->setQuery($q);
			$db->execute();
		}
	...
	WHERE  `virtuemart_category_id`='.(int)$data['category_parent_id'].';';
			$db = JFactory::getDbo();
			$db->setQuery($q);
			$db->execute();
		}
