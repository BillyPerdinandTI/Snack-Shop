 ...
 * @version $Id: waitinglist.php 11219 2025-11-03 19:27:28Z Milbo $
 */
...
class VirtueMartModelWaitingList extends VmModel {
	 ...
	 */
	public function adduser ($data, $checkProductAvailability = true) {

		vRequest::vmCheckToken('Invalid Token, in adduser to waitinglist') or jexit ('');
		...
		//This function is used in the FE and so we need to load the BE language file
		vmLanguage::loadJLang('com_virtuemart');

		if(isset($data['checkProductAvailability'])){
			$checkProductAvailability = $data['checkProductAvailability'];
		}
