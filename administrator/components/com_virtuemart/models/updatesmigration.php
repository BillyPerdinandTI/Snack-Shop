...
* @version $Id: updatesmigration.php 11221 2025-11-05 19:53:13Z Milbo $
*/
...
';
	...
	public function updateJoomlaUpdateServer( $type, $element, $dst, $group=''  ){
		...
		if(JFile::exists($extensionXmlFileName)){
			...
			vmdebug('updateJoomlaUpdateServer xml file not found ',$type, $element, $dst, $extensionXmlFileName);
			return false;
		}
