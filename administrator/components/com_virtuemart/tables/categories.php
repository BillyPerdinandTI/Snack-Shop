...
* @version $Id: categories.php 11199 2025-09-23 19:08:38Z Milbo $
*/
...
// 		$this->setPrimaryKey('virtuemart_category_id');
	...
	public function check(){
		...
		$this->category_parent_id = (int)$this->category_parent_id;
		$this->virtuemart_vendor_id = (int)$this->virtuemart_vendor_id;
		return parent::check();
	}
