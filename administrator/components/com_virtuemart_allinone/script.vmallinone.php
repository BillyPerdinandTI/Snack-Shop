...
/*		$this->installPlugin ('VM Payment - Klarna', 'plugin', 'klarna', 'vmpayment');
		...
		if ($task != 'updateDatabase') {
			...
			$this->installModule ('VM - Currencies Selector', 'mod_virtuemart_currencies', 5, $defaultParams, $dst, 0,'sidebar-right',1,$alreadyInstalled);
			...
			$this->installModule ('VM - Featured products', 'mod_virtuemart_product', 3, $defaultParams, $dst, 0,'sidebar-right',1,$alreadyInstalled);
			...
			$this->installModule ('VM - Best Sales', 'mod_virtuemart_product', 1, $defaultParams, $dst, 0,'sidebar-right',1,$alreadyInstalled);

			$defaultParams = '{"width":"20","text":"","button":"","button_pos":"right","imagebutton":"","button_text":""}';
			$this->installModule ('VM - Search in Shop', 'mod_virtuemart_search', 2, $defaultParams, $dst, 0,'sidebar-right',1,$alreadyInstalled);

			$defaultParams = '{"show":"all","display_style":"list","manufacturers_per_row":"1","headerText":"","footerText":""}';
			$this->installModule ('VM - Manufacturer', 'mod_virtuemart_manufacturer', 8, $defaultParams, $dst, 0,'sidebar-right',1,$alreadyInstalled);

			$defaultParams = '{"moduleclass_sfx":"","show_price":"1","show_product_list":"1"}';
			$this->installModule ('VM - Shopping cart', 'mod_virtuemart_cart', 0, $defaultParams, $dst, 0,'sidebar-right',1,$alreadyInstalled);

			$defaultParams = '{"Parent_Category_id":"0","layout":"default","cache":"0","moduleclass_sfx":"","class_sfx":""}';
			$this->installModule ('VM - Category', 'mod_virtuemart_category', 4, $defaultParams, $dst, 0,'sidebar-right',1,$alreadyInstalled);

			$defaultParams = '{"dropdown":"0","image":"1","inline":"1","show_active":"1","full_name":"1","cache":"1","cache_time":"900","cachemode":"itemid"}';
			$this->installModule ('VM - Language Switcher', 'mod_virtuemart_languages', 4, $defaultParams, $dst, 0,'sidebar-right',1,$alreadyInstalled);

			$defaultParams = '{"show":"all","display_style":"list","display_tos_link":"1","display_about_link":"1","@spacer":"","headerText":"","footerText":"","cache":"1","moduleclass_sfx":"","class_sfx":""}';
			$this->installModule ('VM - Vendor', 'mod_virtuemart_vendor', 4, $defaultParams, $dst, 0,'sidebar-right',1,$alreadyInstalled);
	...
	public function installModule ($title, $module, $ordering, $params, $src, $client_id = 0, $position = 'sidebar-right', $access = 1, $alreadyInstalled = true) {
