	...
	public function display ($tpl = NULL) {
		...
		foreach ($products as $product) {
			...
			if ($feed_show_prices == 1  and  $show_prices == 1) {
				...
				$unitPriceDescription = $product->product_unit ? vmText::sprintf ('COM_VIRTUEMART_PRODUCT_UNITPRICE', vmText::_('COM_VIRTUEMART_UNIT_SYMBOL_'.strtoupper($product->product_unit))) : '';				$description .= $currency->createPriceDiv ('unitPrice', $unitPriceDescription, $product->prices);
