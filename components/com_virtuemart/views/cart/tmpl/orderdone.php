...
* @copyright Copyright (c) 2004 - 2025 VirtueMart Team. All rights reserved.
...
if (vRequest::getBool('display_loginform',true)) {
	...
	if (!$cuser->guest) echo shopFunctionsF::getLoginForm(false, false, 'index.php?option=com_virtuemart&view=cart');
}
echo '</div>';
